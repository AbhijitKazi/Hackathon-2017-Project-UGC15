                ...
                <h1 class="text-center">Queries</h1>
                    ...
                    <div class="panel-body">
                        <table class=" table table-bordered table-fixed">
                            ...
                            <tbody>
                                <?php
                                $sql_query = mysqli_query($conn,"SELECT * FROM query WHERE category=1 ORDER BY q_id DESC");
                ...
                <h1 class="text-center">Complaints</h1>
                    ...
                    <div class="panel-body">
                        <table class=" table table-bordered table-fixed">
                            ...
                            <tbody>
                                <?php
                                $sql_com = mysqli_query($conn,"SELECT * FROM complaint ORDER BY c_id DESC");
        ...
        <div class="col-md-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <label class="glyphicon glyphicon-pencil"><a href="faq.php"> Update FAQs</a></label>
                </div>
            </div>
        </div>
        <div class="col-md-10">
