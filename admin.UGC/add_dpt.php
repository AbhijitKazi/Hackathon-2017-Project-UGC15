        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="insert_dpt.php" name="form" method="POST"
                          id="contact_form" onsubmit="return validateForm();" enctype="multipart/form-data">
                        <div class="inner-wrap">
                            <label><b>Department:</b> 
                                <input type="text" name="d_name" placeholder="Name" required="required">
                            ...
                            <label><b>Log Name:</b> 
                                <input type="text" name="log_name" placeholder="User Name" required="required">
                                <span id="name_validation" class="error"></span>
                            </label>
                            <label><b>Password:</b> 
