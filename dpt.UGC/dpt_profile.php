...
$query = mysqli_query($conn,"SELECT * from department WHERE log_name = '$user'");
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="dpt_dashboard.php"><?php echo $arr['d_name'];?></a>
                    </li>
                    <li>
        ...
        <div class="container text-center">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <label><h4>Name:</h4> <?php echo $arr['d_name'];?></label><br>
                    
                    <label><h4>Phone Number:</h4> <?php echo $arr['ph_no'];?></label>
                    <form action="updt_dptpro.php" method="POST">
                    ...
                    <label><h4>User Name:</h4> <?php echo $arr['log_name'];?></label><br>
                    
                    </form>
                    
                </div>
            </div>
            <a href="change_dptpw.html">Change Password</a>
        </div>
        <!-- jQuery -->
