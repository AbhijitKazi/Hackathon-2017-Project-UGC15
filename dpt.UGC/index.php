...
include("connection.php");
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT log_name FROM department WHERE log_name = '$myusername' and password = '$mypassword'";
    ...
    //  $active = $row['active'];
      ...
      if($count == 1) {
         ...
         header("location: dpt_dashboard.php");
      }else {
...
<html lang="en-US" class="no-js">
    <head>
        ...
        <title>Login | UGC Department Panel</title>
                        ...
                        <div id="login" class="animate form">
                            <form  action="" autocomplete="on" method="post"> 
                                ...
                                <p> 
                                    ...
                                    <input id="log_name" name="u_name" required="required" type="text" />
                                </p>
                                <p> 
